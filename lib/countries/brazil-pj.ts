...
export const brazilPJ: CountryConfig = {
  ...
  currencySymbol: "R$",
  city: "São Paulo",
  inputLabel: "Faturamento bruto mensal",
  inputPlaceholder: "20.000",
  inputPeriod: "monthly",
  eurPerUnit: 1 / 6.2,
  purchasingPowerIndex: 44,
  costOfLiving: [
    { label: "Aluguel 1-quarto (centro)", monthly: 4500 },
    { label: "Aluguel 1-quarto (fora do centro)", monthly: 2800 },
    { label: "Alimentação mensal", monthly: 1600 },
    { label: "Transporte público", monthly: 260 },
    { label: "Internet + celular", monthly: 180 },
    { label: "Saúde (plano particular)", monthly: 600 },
    { label: "Lazer e entretenimento", monthly: 800 },
  ],
  benefits: {
