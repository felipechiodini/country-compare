          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-600">
                Calculadora de salário para devs — compare qualquer país e modalidade
              </p>
            </div>
          </div>

          <a
            href="https://github.com/felipe-bona/comparar-paises"
            target="_blank"
      ...
      <footer className="border-t border-gray-200 bg-white mt-12">
        <div className="max-w-5xl mx-auto px-4 py-6 text-center space-y-3">
          ...
          >
            ...
            Contribua com o projeto em github.com/felipe-bona/comparar-paises
          </a>
